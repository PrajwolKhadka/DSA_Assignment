 ...
 */
/**QUESTION 1a
 * This class calculates the minimum number of measurements required to reach a certain number of total measurements.
 * The measurements are calculated based on a recursive formula where each measurement is the sum of the previous measurement and the measurement before that, plus one.
 * The class contains a single method, minMeasurements, which takes two parameters: k, the initial number of measurements, and n, the target number of total measurements.
 */
